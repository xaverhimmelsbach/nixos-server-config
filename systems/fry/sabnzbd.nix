{ config, ... }:
{
  users.groups."acme-sabnzbd.himmelsbach.dev" = {
    members = [
      "acme"
      "nginx"
    ];
  ...
  security.acme = {
    certs."sabnzbd.himmelsbach.dev" = {
      dnsProvider = "hetzner";
      environmentFile = config.age.secrets.hetzner-api-key.path;
      group = "acme-sabnzbd.himmelsbach.dev";
    };
  };

  services.nginx = {
    virtualHosts."sabnzbd.himmelsbach.dev" = {
      forceSSL = true;
      sslCertificate = "/var/lib/acme/sabnzbd.himmelsbach.dev/cert.pem";
      sslCertificateKey = "/var/lib/acme/sabnzbd.himmelsbach.dev/key.pem";
      locations."/" = {
  ...
  services.sabnzbd = {
    enable = true;
    configFile = builtins.toFile "sabnzbd.ini" ''
      __version__ = 19
      __encoding__ = utf-8
      [misc]
      ...
      enable_https = 0
      inet_exposure = 0
      api_key = f94fdd6364434ccf844f692705316871
      nzb_key = 597a046b298749a184341fc3351c1cf7
      socks5_proxy_url = ""
      permissions = ""
      download_dir = /var/lib/sabnzbd/Downloads/incomplete
      download_free = ""
      complete_dir = /var/lib/sabnzbd/Downloads/complete
      complete_free = ""
      fulldisk_autoresume = 0
      script_dir = "/var/lib/sabnzbd/script"
      ...
      ipv6_servers = 1
      url_base = ""
      host_whitelist = sabnzbd.himmelsbach.dev
      local_ranges = ,
      max_url_retries = 10
